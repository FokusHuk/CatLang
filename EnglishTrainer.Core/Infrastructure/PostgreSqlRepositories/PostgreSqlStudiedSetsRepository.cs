...
{
    public class PostgreSqlStudiedSetsRepository : IStudiedSetsRepository
    {
        private readonly IDbConnection _connection;
        
        public PostgreSqlStudiedSetsRepository(IDbConnection connection)
        {
        ...
        public List<StudiedSetDto> GetStudiedSets()
        {
            var result = _connection
                .Query<StudiedSetDto>("select * from public.\"UserStudiedSets\"")
                .ToList();
        ...
        {
            var result = _connection
                .Query<StudiedSetDto>(@"update public.""UserStudiedSets""
                set
        ...
        {
            var a = _connection
                .Query<Word>(@"insert into public.""UserStudiedSets""
