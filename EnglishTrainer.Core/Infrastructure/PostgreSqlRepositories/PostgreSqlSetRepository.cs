...
{
    public class PostgreSqlSetRepository: ISetRepository
    {
        private readonly IDbConnection _connection;
        
        public PostgreSqlSetRepository(IDbConnection connection)
        {
        ...
        public List<WordsSetDto> GetAll()
        {
            var result = _connection
                .Query<WordsSetDto>("select * from public.\"Sets\"")
                .ToList();
        ...
        {
            _connection
                .Query<Word>(@"insert into public.""Sets""
        ...
        {
            _connection
                .Query<WordsSetDto>(@"update public.""Sets""
                set 
